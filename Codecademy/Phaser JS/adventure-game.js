...
function create() {
  // This creates a background image centered at (0, 0), 
  // but we want (0, 0) to be the top-left corner.
  gameState.background = this.add.image(0, 0, 'bg');
  // We can use .setOrigin() to indicate we want to change 
  // the behavior of how our image is centered.
